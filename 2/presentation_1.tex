...
\author[A.Zamani]{A.Zamani\\[1mm]{\small Supervised by: Dr. S.Sharifian}} % Your name
...
%------------------------------------------------
\subsection[IoT]{Internet of Things (IoT)} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
\subsection[Fog-to-Cloud]{Fog-to-Cloud architecture}
